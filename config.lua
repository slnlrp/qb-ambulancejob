...
Config.Locations = {
    ["checking"] = vector3(-817.72, -1236.56, 7.34), --vector3(308.19, -595.35, 43.29),
    ["duty"] = {
        [1] = vector3(-814.52, -1240.04, 7.34), --vector3(311.18, -599.25, 43.29),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] =  vector4(-840.68, -1228.91, 6.93,46.08), --vector4(294.578, -574.761, 43.179, 35.792),
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ["helicopter"] = {
        [1] = vector4(-790.99, -1191.62, 53.03, 44.7),--vector4(351.58, -587.45, 74.16, 160.5),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(-819.95, -1243.0, 7.34),--vector3(309.93, -602.94, 43.29),
        [2] = vector3(-245.13, 6315.71, 32.82),
    },
    ["roof"] = {
        [1] = vector4(-773.59, -1207.32, 51.15, 306.5),--vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(-793.91, -1246.1, 7.34), --vector3(298.44, -599.7, 43.29),
    },
    ["stash"] = {
        [1] = vector3(-824.45, -1239.68, 7.34),
    },
    ["beds"] = {
        [1] = {coords = vector4(-804.13, -1231.28, 7.26, 313.57), taken = false, model = 1631638868},
        [2] = {coords = vector4(-806.66, -1229.03, 7.26, 308.6), taken = false, model = 1631638868},
        [3] = {coords = vector4(-809.42, -1226.65, 7.26, 311.75), taken = false, model = 2117668672},
        [4] = {coords = vector4(-812.1, -1224.49, 7.26, 313.62), taken = false, model = 2117668672},
        [5] = {coords = vector4(-809.34, -1220.9, 7.26, 127.91), taken = false, model = 2117668672},
        [6] = {coords = vector4(-805.43, -1223.92, 7.26, 128.91), taken = false, model = -1091386327},
        [7] = {coords = vector4(-809.45, -1220.98, 7.26, 132.86), taken = false, model = -1091386327},
        [8] = {coords = vector4(-799.8, -1234.72, 7.26, 330.84), taken = false, model = -1091386327},
        [9] = {coords = vector4(-795.09, -1216.66, 7.26, 119.62), taken = false, model = -1091386327},
    ...
    ["stations"] = {
        [1] = {label = "Lost Santos South Hospital", coords = vector4(-827.14, -1218.47, 6.93, 49.47)}
    }
}
...
Config.AuthorizedVehicles = {
	-- Grade 0
	[0] = {
        ["nhsvolvo"] = "Volvo Hatchback",
        ["nhsmercedes"] = "Mercedes Ambulance",
        ["nhsx5"] = "NHS BMW X5",
        ["nhssprinter"] = "NHS Sprinter"
	},
	-- Grade 1
	[1] = {
        ["nhsvolvo"] = "Volvo Hatchback",
